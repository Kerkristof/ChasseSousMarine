...
/* base.html.twig */
class __TwigTemplate_867778ecbffced51af15d343cf6c0303f26d0e663f2f438cf32a77c8c1b6bd81 extends Template
{
    private $source;
    private $macros = [];
    ...
    <nav class=\"navbar navbar-expand-lg navbar-dark bg-info\">
      ...
      <div class=\"collapse navbar-collapse\" id=\"navbarColor03\">
        ...
        if (twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 30, $this->source); })()), "user", [], "any", false, false, false, 30)) {
            ...
            echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("sortie_mine");
            echo "\">Mes sorties</a>
            ";
        }
        // line 33
...
";
    ...
    {
        return array (  223 => 53,  205 => 51,  187 => 9,  168 => 5,  153 => 54,  151 => 53,  148 => 52,  146 => 51,  140 => 47,  133 => 43,  129 => 42,  126 => 41,  120 => 38,  117 => 37,  115 => 36,  110 => 33,  104 => 31,  102 => 30,  96 => 27,  90 => 24,  84 => 21,  73 => 13,  68 => 10,  66 => 9,  62 => 8,  58 => 7,  53 => 5,  47 => 1,);
    }
...
<html>
  <head>
      <meta charset=\"UTF-8\">
      <title>{% block title %}La chasse sous marine!{% endblock %}</title>
      <link rel=\"stylesheet\" href=\"https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css\" integrity=\"sha384-Vkoo8x4CGsO3+Hhxv8T/Q5PaXtkKtu6ug5TOeNV6gBiFeWPGFN9MuhOf23Q9Ifjh\" crossorigin=\"anonymous\">
      <link rel=\"stylesheet\" href=\"{{ asset('assets/css/monStyle.css') }}\">
      <link rel=\"icon\" href=\"{{ asset('assets/images/icones/masque.png') }}\">
      {% block stylesheets %}{% endblock %}
  </head>
  <body>
    <nav class=\"navbar navbar-expand-lg navbar-dark bg-info\">
      <a class=\"navbar-brand\" href=\"{{ path('home') }}\">La pêche sous marine</a>
      <button class=\"navbar-toggler\" type=\"button\" data-toggle=\"collapse\" data-target=\"#navbarColor03\" aria-controls=\"navbarColor03\" aria-expanded=\"false\" aria-label=\"Toggle navigation\">
        <span class=\"navbar-toggler-icon\"></span>
      </button>
      ...
      <div class=\"collapse navbar-collapse\" id=\"navbarColor03\">
        <ul class=\"navbar-nav mr-auto\">
          ...
          <li class=\"nav-item\">
            <a class=\"nav-link\" href=\"{{ path('site_index') }}\">Les sites</a>
          </li>
          <li class=\"nav-item\">
            <a class=\"nav-link\" href=\"{{ path('blog') }}\">Le blog</a>
          </li>
          <li class=\"nav-item\">
            {% if app.user %}
              <a class=\"nav-link\" href=\"{{ path('sortie_mine') }}\">Mes sorties</a>
            {% endif %}
          </li>
        </ul>
        <ul class=\"navbar-nav\">
...
", "base.html.twig", "/home/christophe/Projects/Symfony/ChasseSousMarine/templates/base.html.twig");
    }
}
